...
const u8 gText_TeachWhichPokemon[] = _("教给哪只宝可梦?");
const u8 gText_UseOnWhichPokemon[] = _("给哪只宝可梦使用?");
const u8 gText_GiveToWhichPokemon[] = _("给哪个宝可梦?");
const u8 gText_DoWhatWithPokemon[] = _("对{PKMN}做什么?");
...
const u8 gText_BoostPp[] = _("给哪个技能提升PP?");
...
const u8 gText_TheresNoMailHere[] = _("这里没有任何道具.{PAUSE_UNTIL_PRESS}");
