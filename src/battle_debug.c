...
static const u8 sText_Ability[] = _("能力");
static const u8 sText_Moves[] = _("招式");
static const u8 sText_Stats[] = _("属性");
static const u8 sText_StatStages[] = _("属性阶段");
static const u8 sText_Status1[] = _("状态1");
static const u8 sText_Status2[] = _("状态2");
static const u8 sText_Status3[] = _("状态3");
static const u8 sText_HeldItem[] = _("携带物品");
static const u8 sText_SideStatus[] = _("场地状态");
static const u8 sText_MaxHp[] = _("HP最大");
static const u8 sText_CurrHp[] = _("HP当前");
static const u8 sText_Freeze[] = _("冰冻");
static const u8 sText_ToxicPoison[] = _("中毒(剧毒)");
static const u8 sText_ToxicCounter[] = _("剧毒计数");
static const u8 sText_Flinch[] = _("畏缩");
static const u8 sText_Uproar[] = _("喧哗");
static const u8 sText_Bide[] = _("忍耐");
static const u8 sText_LockConfuse[] = _("混乱锁定");
static const u8 sText_MultipleTurns[] = _("多回合动作");
static const u8 sText_FocusEnergy[] = _("集中精力");
...
static const u8 sText_DestinyBond[] = _("命运之结");
static const u8 sText_CantEscape[] = _("无法逃脱");
static const u8 sText_Nightmare[] = _("噩梦");
static const u8 sText_Cursed[] = _("诅咒");
static const u8 sText_Foresight[] = _("先见之明");
static const u8 sText_DefenseCurl[] = _("防卷缩");
static const u8 sText_Tormented[] = _("烦恼");
static const u8 sText_AlwaysHits[] = _("必定命中");
static const u8 sText_ChargedUp[] = _("充电完成");
static const u8 sText_Rooted[] = _("扎根");
static const u8 sText_Yawned[] = _("打哈欠");
static const u8 sText_Minimized[] = _("缩小");
static const u8 sText_NoCrit[] = _("不会暴击");
static const u8 sText_Imprisoned[] = _("监禁");
static const u8 sText_Reflect[] = _("反射护盾");
static const u8 sText_LightScreen[] = _("光墙");
static const u8 sText_Spikes[] = _("尖石");
static const u8 sText_Safeguard[] = _("保护");
static const u8 sText_Mist[] = _("雾");
static const u8 sText_ShowOpponentHP[] = _("对手HP");
static const u8 sText_Types[] = _("类型");
static const u8 sText_PP[] = _("PP");
static const u8 sText_AI[] = _("AI");
static const u8 sText_NoBadMoves[] = _("无糟糕招式");
static const u8 sText_Viability[] = _("可行性");
static const u8 sText_TryFaint[] = _("尝试倒下");
static const u8 sText_SetUpFirstTurn[] = _("第一回合设置");
static const u8 sText_Risky[] = _("冒险");
static const u8 sText_StrongestMove[] = _("最强伤害招式");
static const u8 sText_Various[] = _("各种");
static const u8 sText_ShowHP[] = _("显示HP");
static const u8 sText_PreferBatonPass[] = _("接力棒");
static const u8 sText_InDoubles[] = _("双打中");
...
static const u8 sText_HoldEffectCurePar[] = _("治愈麻痹");
static const u8 sText_HoldEffectCureSlp[] = _("治愈睡眠");
static const u8 sText_HoldEffectCurePsn[] = _("治愈中毒");
static const u8 sText_HoldEffectCureBrn[] = _("治愈烧伤");
static const u8 sText_HoldEffectCureFrz[] = _("治愈冰冻");
static const u8 sText_HoldEffectRestorePp[] = _("恢复PP");
static const u8 sText_HoldEffectCureConfusion[] = _("治愈混乱");
static const u8 sText_HoldEffectCureStatus[] = _("治愈所有状态");
static const u8 sText_HoldEffectConfuseSpicy[] = _("混乱(辣)");
static const u8 sText_HoldEffectConfuseDry[] = _("混乱(干)");
static const u8 sText_HoldEffectConfuseSweet[] = _("混乱(甜)");
static const u8 sText_HoldEffectConfuseBitter[] = _("混乱(苦)");
static const u8 sText_HoldEffectConfuseSour[] = _("混乱(酸)");
static const u8 sText_HoldEffectAttackUp[] = _("提升攻击");
static const u8 sText_HoldEffectDefenseUp[] = _("提升防御");
static const u8 sText_HoldEffectSpeedUp[] = _("提升速度");
static const u8 sText_HoldEffectSpAttackUp[] = _("提升特攻");
static const u8 sText_HoldEffectSpDefenseUp[] = _("提升特防");
static const u8 sText_HoldEffectCriticalUp[] = _("提升暴击率");
static const u8 sText_HoldEffectRandomStatUp[] = _("随机提升属性");
static const u8 sText_HoldEffectEvasionUp[] = _("提升闪避");
static const u8 sText_HoldEffectRestoreStats[] = _("恢复所有属性");
static const u8 sText_HoldEffectMachoBrace[] = _("肌肉护腕");
static const u8 sText_HoldEffectExpShare[] = _("经验分享");
static const u8 sText_HoldEffectQuickClaw[] = _("迅爪");
static const u8 sText_HoldEffectFriendshipUp[] = _("提升亲密度");
static const u8 sText_HoldEffectMentalHerb[] = _("心草");
static const u8 sText_HoldEffectChoiceBand[] = _("选择带");
static const u8 sText_HoldEffectFlinch[] = _("造成畏缩");
static const u8 sText_HoldEffectBugPower[] = _("提升虫系力量");
static const u8 sText_HoldEffectDoublePrize[] = _("加倍奖金");
static const u8 sText_HoldEffectRepel[] = _("驱虫剂");
static const u8 sText_HoldEffectSoulDew[] = _("灵魂露");
static const u8 sText_HoldEffectDeepSeaTooth[] = _("深海牙");
static const u8 sText_HoldEffectDeepSeaScale[] = _("深海鳞");
static const u8 sText_HoldEffectCanAlwaysRun[] = _("随时逃跑");
static const u8 sText_HoldEffectPreventEvolve[] = _("阻止进化");
static const u8 sText_HoldEffectFocusBand[] = _("集中带");
static const u8 sText_HoldEffectLuckyEgg[] = _("幸运蛋");
static const u8 sText_HoldEffectScopeLens[] = _("瞄准镜");
static const u8 sText_HoldEffectSteelPower[] = _("提升钢系力量");
static const u8 sText_HoldEffectLeftovers[] = _("剩饭");
static const u8 sText_HoldEffectDragonScale[] = _("龙鳞");
static const u8 sText_HoldEffectLightBall[] = _("光之球");
static const u8 sText_HoldEffectGroundPower[] = _("提升地面系力量");
static const u8 sText_HoldEffectRockPower[] = _("提升岩石系力量");
static const u8 sText_HoldEffectGrassPower[] = _("提升草系力量");
static const u8 sText_HoldEffectDarkPower[] = _("提升恶系力量");
static const u8 sText_HoldEffectFightingPower[] = _("提升格斗系力量");
static const u8 sText_HoldEffectElectricPower[] = _("提升电系力量");
static const u8 sText_HoldEffectWaterPower[] = _("提升水系力量");
static const u8 sText_HoldEffectFlyingPower[] = _("提升飞行系力量");
static const u8 sText_HoldEffectPoisonPower[] = _("提升毒系力量");
static const u8 sText_HoldEffectIcePower[] = _("提升冰系力量");
static const u8 sText_HoldEffectGhostPower[] = _("提升幽灵系力量");
static const u8 sText_HoldEffectPsychicPower[] = _("提升超能力系力量");
static const u8 sText_HoldEffectFirePower[] = _("提升火系力量");
static const u8 sText_HoldEffectDragonPower[] = _("提升龙系力量");
static const u8 sText_HoldEffectNormalPower[] = _("提升一般系力量");
static const u8 sText_HoldEffectUpgrade[] = _("升级装置");
static const u8 sText_HoldEffectShellBell[] = _("贝壳铃铛");
static const u8 sText_HoldEffectLuckyPunch[] = _("幸运拳套");
static const u8 sText_HoldEffectMetalPowder[] = _("金属粉末");
static const u8 sText_HoldEffectThickClub[] = _("厚木棒");
