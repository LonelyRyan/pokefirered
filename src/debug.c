...
static const u8 sDebugText_Continue[] =      _("继续…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
// Main Menu
static const u8 sDebugText_Utilities[] =        _("辅助功能…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_PartyBoxes[] =       _("队伍/盒子…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Scripts[] =          _("脚本…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_FlagsVars[] =        _("变量…{CLEAR_TO 110}{RIGHT_ARROW}");
...
static const u8 sDebugText_Fill[] =             _("填充 电脑/背包{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
...
// Party/Boxes Menu
static const u8 sDebugText_PartyBoxes_AccessPC[] =           _("连接电脑");
static const u8 sDebugText_PartyBoxes_MoveReminder[] =       _("回忆招式");
static const u8 sDebugText_PartyBoxes_HatchAnEgg[] =         _("孵蛋");
static const u8 sDebugText_PartyBoxes_HealParty[] =          _("治疗队伍");
static const u8 sDebugText_PartyBoxes_PoisonParty[] =        _("Poison party");
static const u8 sDebugText_PartyBoxes_ClearBoxes[] =         _("清空盒子");
// Flags/Vars Menu
...
static const u8 sDebugText_FlagsVars_PokedexFlags_All[] =       _("图鉴标志全部");
static const u8 sDebugText_FlagsVars_PokedexFlags_Reset[] =     _("图鉴标志重置");
...
static const u8 sDebugText_FlagsVars_SwitchPokeNav[] =          _("切换{STR_VAR_1}宝可梦导航");
static const u8 sDebugText_FlagsVars_SwitchMatchCall[] =        _("切换{STR_VAR_1}对战通话");
static const u8 sDebugText_FlagsVars_RunningShoes[] =           _("切换{STR_VAR_1}疾跑鞋");
static const u8 sDebugText_FlagsVars_ToggleFlyFlags[] =         _("切换{STR_VAR_1}飞行标志");
static const u8 sDebugText_FlagsVars_ToggleAllBadges[] =        _("切换{STR_VAR_1}全部徽章");
static const u8 sDebugText_FlagsVars_ToggleFrontierPass[] =     _("切换{STR_VAR_1}对战开拓区通行证");
...
static const u8 sDebugText_FlagsVars_SwitchTrainerSee[] =       _("切换{STR_VAR_1}训练家视线关闭");
static const u8 sDebugText_FlagsVars_SwitchQuestLog[] =         _("切换{STR_VAR_1}任务日志关闭");

// Give Menu
static const u8 sDebugText_Give_GiveItem[] =            _("给予物品XYZ…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_ItemQuantity[] =             _("数量:{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n\n{STR_VAR_2}");
static const u8 sDebugText_ItemID[] =                   _("物品ID:{STR_VAR_3}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_Give_AllTMs[] =              _("给予所有技能机器(TM)");
static const u8 sDebugText_Give_GivePokemonSimple[] =   _("宝可梦(等级)…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Give_GivePokemonComplex[] =  _("宝可梦(等级，性别，性格，能力，个体值，招式)…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_PokemonID[] =                _("宝可梦种类:{STR_VAR_3}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonLevel[] =             _("等级:{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonShiny[] =             _("闪光:{CLEAR_TEXT_TO 90}\n   {STR_VAR_2}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonNature[] =            _("性格ID:{STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonAbility[] =           _("能力编号:{STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonIVs[] =               _("所有个体值:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_HP[] =                    _("个体值HP:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_Attack[] =                _("个体值攻击:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_Defense[] =               _("个体值防御:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_Speed[] =                 _("个体值速度:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_SpAttack[] =              _("个体值特攻:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_SpDefense[] =             _("个体值特防:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonMove_0[] =            _("招式0:{STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonMove_1[] =            _("招式1:{STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonMove_2[] =            _("招式2:{STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonMove_3[] =            _("招式3:{STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_Give_MaxMoney[] =            _("最大金额");
static const u8 sDebugText_Give_MaxCoins[] =            _("最大游戏币");
static const u8 sDebugText_Give_BattlePoints[] =        _("最大对战点数");
static const u8 sDebugText_Give_DaycareEgg[] =          _("托儿所蛋");
// Fill Menu
static const u8 sDebugText_Fill_Pc_Fast[] =             _("快速填充电脑盒子");
static const u8 sDebugText_Fill_Pc_Slow[] =             _("缓慢填充电脑盒子(可能会卡顿！)");
static const u8 sDebugText_Fill_Pc_Items[] =            _("填充电脑物品");
static const u8 sDebugText_Fill_PocketItems[] =         _("填充背包物品");
static const u8 sDebugText_Fill_PocketPokeBalls[] =     _("填充背包宝可梦球");
static const u8 sDebugText_Fill_PocketTMHM[] =          _("填充背包技能机器(TM/HM");
static const u8 sDebugText_Fill_PocketBerries[] =       _("填充背包树果");
static const u8 sDebugText_Fill_PocketKeyItems[] =      _("填充背包重要道具");
// Sound Menu
static const u8 sDebugText_Sound_SFX[] =                _("音效…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Sound_SFX_ID[] =             _("音效ID:{STR_VAR_3}   {START_BUTTON} 停止\n{STR_VAR_1}    \n{STR_VAR_2}");
static const u8 sDebugText_Sound_Music[] =              _("音乐…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
