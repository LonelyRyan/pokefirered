...
static const u8 sText_TooScaredToMove[] = _("{B_ATK_NAME_WITH_PREFIX}太害怕了，无法动弹！");
static const u8 sText_GetOutGetOut[] = _("幽灵：出去…… 出去……");
static const u8 sText_StatSharply[] = _("大幅 ");
const u8 gBattleText_Rose[] = _("上升了！");
static const u8 sText_StatHarshly[] = _("大幅 ");
static const u8 sText_StatFell[] = _("下降了！");
...
static const u8 sText_UsingItemTheStatOfPkmnRose[] = _("使用{B_LAST_ITEM}，{B_SCR_ACTIVE_NAME_WITH_PREFIX}的\n{B_BUFF1}{B_BUFF2}");
...
static const u8 sText_StatsWontIncrease2[] = _("{B_ATK_NAME_WITH_PREFIX}的属性无法\n再提升了！");
static const u8 sText_StatsWontDecrease2[] = _("{B_DEF_NAME_WITH_PREFIX}的属性无法\n再下降了！");
static const u8 sText_CriticalHit[] = _("这是要害一击！");
static const u8 sText_OneHitKO[] = _("一击必杀！");
static const u8 sText_123Poof[] = _("{PAUSE 32}1，{PAUSE 15}2，{PAUSE 15}…… {PAUSE 15}…… {PAUSE 15}…… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}嘭！\p");
static const u8 sText_AndEllipsis[] = _("然后……\p");
static const u8 sText_HMMovesCantBeForgotten[] = _("隐藏技能现在\n无法遗忘。\p");
static const u8 sText_NotVeryEffective[] = _("效果不佳……");
static const u8 sText_SuperEffective[] = _("效果绝佳！");
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}成功逃脱！\p");
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX}使用了它的{B_LAST_ITEM}\n逃跑了！\p");
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX}使用了{B_ATK_ABILITY}\n逃跑了！\p");
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE SE_FLEE}野生的{B_BUFF1}逃跑了！");
static const u8 sText_PlayerDefeatedLinkTrainer[] = _("玩家击败了\n{B_LINK_OPPONENT1_NAME}！");
static const u8 sText_TwoLinkTrainersDefeated[] = _("玩家击败了{B_LINK_OPPONENT1_NAME}\n和{B_LINK_OPPONENT2_NAME}！");
static const u8 sText_PlayerLostAgainstLinkTrainer[] = _("玩家输给了\n{B_LINK_OPPONENT1_NAME}！");
static const u8 sText_PlayerLostToTwo[] = _("玩家输给了{B_LINK_OPPONENT1_NAME}\n和{B_LINK_OPPONENT2_NAME}！");
...
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME}逃跑了！");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME}和\n{B_LINK_OPPONENT2_NAME}逃跑了！");
static const u8 sText_NoRunningFromTrainers[] = _("不！训练家之间的对战\n不能逃跑！\p");
static const u8 sText_CantEscape[] = _("无法逃脱！\p");
static const u8 sText_DontLeaveBirch[] = _(""); // 未使用
static const u8 sText_ButNothingHappened[] = _("但什么都没发生！");
static const u8 sText_ButItFailed[] = _("但失败了！");
static const u8 sText_ItHurtConfusion[] = _("它在混乱中\n伤害了自己！");
static const u8 sText_MirrorMoveFailed[] = _("镜动失败了！");
static const u8 sText_StartedToRain[] = _("开始下雨了！");
static const u8 sText_DownpourStarted[] = _("开始下暴雨了！"); // 对应GSC中的暴雨文本，由雨舞技能触发
static const u8 sText_RainContinues[] = _("雨还在下。");
static const u8 sText_DownpourContinues[] = _("暴雨还在继续。"); // 未使用
static const u8 sText_RainStopped[] = _("雨停了。");
static const u8 sText_SandstormBrewed[] = _("沙暴形成了！");
static const u8 sText_SandstormRages[] = _("沙暴正在肆虐。");
static const u8 sText_SandstormSubsided[] = _("沙暴平息了。");
static const u8 sText_SunlightGotBright[] = _("阳光变得强烈！");
static const u8 sText_SunlightStrong[] = _("阳光很强。");
static const u8 sText_SunlightFaded[] = _("阳光变弱了。");
static const u8 sText_StartedHail[] = _("开始下冰雹！");
static const u8 sText_HailContinues[] = _("冰雹还在下。");
static const u8 sText_HailStopped[] = _("冰雹停了。");
static const u8 sText_FailedToSpitUp[] = _("但它没能吐出\n任何东西！");
static const u8 sText_FailedToSwallow[] = _("但它没能吞下\n任何东西！");
static const u8 sText_WindBecameHeatWave[] = _("风变成了\n热浪！");
static const u8 sText_StatChangesGone[] = _("所有属性变化都被\n消除了！");
static const u8 sText_CoinsScattered[] = _("硬币散落一地！");
static const u8 sText_TooWeakForSubstitute[] = _("它太弱了，无法制造\n替身！");
static const u8 sText_SharedPain[] = _("双方共同承受\n了伤害！");
static const u8 sText_BellChimed[] = _("铃铛响了！");
static const u8 sText_FaintInThree[] = _("所有受影响的宝可梦将在\n三回合后失去意识！");
static const u8 sText_NoPPLeft[] = _("这个招式已经没有PP了！\p");
static const u8 sText_ButNoPPLeft[] = _("但这个招式已经没有PP了！");
static const u8 sText_PkmnIgnoresAsleep[] = _("{B_ATK_NAME_WITH_PREFIX}在睡觉时\n无视了指令！");
static const u8 sText_PkmnIgnoredOrders[] = _("{B_ATK_NAME_WITH_PREFIX}无视了\n指令！");
static const u8 sText_PkmnBeganToNap[] = _("{B_ATK_NAME_WITH_PREFIX}开始打盹！");
static const u8 sText_PkmnLoafing[] = _("{B_ATK_NAME_WITH_PREFIX}正在\n偷懒！");
static const u8 sText_PkmnWontObey[] = _("{B_ATK_NAME_WITH_PREFIX}不服从\n指令！");
static const u8 sText_PkmnTurnedAway[] = _("{B_ATK_NAME_WITH_PREFIX}转过身！");
static const u8 sText_PkmnPretendNotNotice[] = _("{B_ATK_NAME_WITH_PREFIX}假装\n没注意到！");
static const u8 sText_EnemyAboutToSwitchPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}即将派出{B_BUFF2}。\p{B_PLAYER_NAME}要更换\n宝可梦吗？");
static const u8 sText_PkmnLearnedMove2[] = _("{B_ATK_NAME_WITH_PREFIX}学会了\n{B_BUFF1}！");
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("玩家击败了\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}！\p");
...
static const u8 sText_PkmnIsEating[] = _("{B_OPPONENT_MON1_NAME}正在吃东西！");
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}播音员：你的狩猎球用完了！游戏结束！\p");
...
static const u8 sText_SilphScopeUnveil[] = _("西尔佛探测器揭示了幽灵的\n身份！");
static const u8 sText_TheGhostWas[] = _("幽灵原来是玛瑙兽！\p");
...
static const u8 sText_GoTwoPkmn[] = _("上吧！{B_PLAYER_MON1_NAME}和\n{B_PLAYER_MON2_NAME}！");
static const u8 sText_GoPkmn2[] = _("上吧！{B_BUFF1}！");
static const u8 sText_DoItPkmn[] = _("上啊！{B_BUFF1}！");
static const u8 sText_GoForItPkmn[] = _("加油！{B_BUFF1}！");
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("对手很弱！\n上啊，{B_BUFF1}！");
...
static const u8 sText_PkmnThatsEnough[] = _("{B_BUFF1}，够了！\n回来吧！");
static const u8 sText_PkmnComeBack[] = _("{B_BUFF1}，回来吧！");
static const u8 sText_PkmnOkComeBack[] = _("{B_BUFF1}，好！\n回来吧！");
const u8 sText_PkmnGoodComeBack[] = _("{B_BUFF1}，干得好！\n回来吧！");
...
static const u8 sText_FoePkmnPrefix[] = _("对手");
...
static const u8 sText_PokeblockWasTooDry[] = _("太干了！");
...
static const u8 sText_OldManUsedItem[] = _("老先生使用了\n{B_LAST_ITEM}！");
static const u8 sText_PokedudeUsedItem[] = _("宝可梦迷使用了\n{B_LAST_ITEM}！");
static const u8 sText_Trainer1UsedItem[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\n使用了{B_LAST_ITEM}！");
static const u8 sText_TrainerBlockedBall[] = _("训练家挡住了精灵球！");
static const u8 sText_DontBeAThief[] = _("别当小偷！");
static const u8 sText_ItDodgedBall[] = _("它躲开了扔出的精灵球！\n这只宝可梦抓不到！");
static const u8 sText_YouMissedPkmn[] = _("你没抓到宝可梦！");
static const u8 sText_PkmnBrokeFree[] = _("哦，不！\n宝可梦挣脱了！");
static const u8 sText_ItAppearedCaught[] = _("哎呀！\n看起来好像抓到了！");
static const u8 sText_AarghAlmostHadIt[] = _("啊！\n差点就抓到了！");
static const u8 sText_ShootSoClose[] = _("真可惜！\n差一点就成功了！");
static const u8 sText_ItDodgedBall2[] = _("躲开了！\n这只宝可梦好像抓不到！"); // 未使用的玛瑙兽幽灵躲避文本
static const u8 sText_GotchaPkmnCaught[] = _("抓到了！\n{B_OPPONENT_MON1_NAME}被抓到了！{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p");
static const u8 sText_GotchaPkmnCaught2[] = _("抓到了！\n{B_OPPONENT_MON1_NAME}被抓到了！{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 127}");
static const u8 sText_GiveNicknameCaptured[] = _("要给抓到的\n{B_OPPONENT_MON1_NAME}起个昵称吗？");
static const u8 sText_PkmnSentToPC[] = _("{B_OPPONENT_MON1_NAME}被送到了\n{B_PC_CREATOR_NAME}的电脑里。");
static const u8 sText_Someones[] = _("某人的");
static const u8 sText_Bills[] = _("比尔的");
static const u8 sText_PkmnDataAddedToDex[] = _("{B_OPPONENT_MON1_NAME}的资料被\n添加到了宝可梦图鉴。\p");
static const u8 sText_ItIsRaining[] = _("正在下雨。"); // 仅在RSE中用于雨区对战开始时
static const u8 sText_SandstormIsRaging[] = _("沙暴正在肆虐。");
static const u8 sText_BoxIsFull[] = _("盒子满了！\n你抓不了更多了！\p");
static const u8 sText_EnigmaBerry[] = _("谜之果实");
static const u8 sText_BerrySuffix[] = _("果实");
static const u8 sText_Enigma[] = _("谜之");
...
static const u8 sText_ItemAllowsOnlyYMove[] = _("{B_LAST_ITEM}的效果只能使用\n{B_CURRENT_MOVE}！\p");
static const u8 sText_PkmnHungOnWithX[] = _("{B_DEF_NAME_WITH_PREFIX}用它的{B_LAST_ITEM}\n坚持住了！");
const u8 gText_EmptyString3[] = _("");
static const u8 sText_PlayedFluteCatchyTune[] = _("{B_PLAYER_NAME}演奏了{B_LAST_ITEM}。\p这个曲子真好听！");
static const u8 sText_PlayedThe[] = _("{B_PLAYER_NAME}演奏了\n{B_LAST_ITEM}。");
...
const u8 gText_KeepAnEyeOnHP[] = _("奥克：注意你的宝可梦的HP。\p如果HP降到“0”，\n它就会失去战斗能力。");
const u8 gText_OakNoRunningFromATrainer[] = _("奥克：不！训练家之间的宝可梦对战\n不能逃跑！");
const u8 gText_WinEarnsPrizeMoney[] = _("奥克：嗯！干得不错！\p如果你赢了，就能获得奖金，\n你的宝可梦也会成长！\p和其他训练家对战，\n让你的宝可梦变得更强大吧！");
const u8 gText_HowDissapointing[] = _("奥克：嗯……\n真令人失望……\p如果你赢了，就能获得奖金，\n你的宝可梦也会成长。\p但如果你输了，{B_PLAYER_NAME}，你就会支付奖金……\p不过这次你没有被告知，\n我会替你付钱。\p但一旦你走出这扇门，\n事情就不会这样了。\p所以你要通过和野生宝可梦对战，\n让自己的宝可梦变得更强大。");
